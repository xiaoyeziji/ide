...
1.  Hadoop集群搭建
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756511593_zh-CN.png)
...
2.  MaxCompute
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756511594_zh-CN.png)
...
1.  Hadoop集群创建测试数据
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756511595_zh-CN.png)
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756511596_zh-CN.png)

2.  利用DataWorks新建目标表

    在管理控制台，选择对应的MaxCompute项目，点击进入数据开发页面，点击新建表，如下所示。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756511597_zh-CN.png)
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756511598_zh-CN.png)
    ...
    **说明：** 考虑到部分HIVE与MaxCompute数据类型的兼容问题，建议在odpscmd客户端上执行以下命令。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756511599_zh-CN.png)
...
1.  新建自定义资源组
    ...
    1.  查看Hadoop集群datanode
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756511600_zh-CN.png)

        您也可以通过点击上图中Master节点的ECS ID，进入ECS实例详情页，通过点击远程连接进入ECS，通过 hadoop dfsadmin –report命令查看datenode，如下图所示。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756611601_zh-CN.png)

        由上图可以看到，在本例中，datanode只具有内网地址，很难与DataWorks默认资源组互通，所以我们需要设置自定义资源组，将master node设置为执行DataWorks数据同步任务的节点。

    2.  新建自定义资源组

        进入DataWorks数据集成页面，选择资源组，点击新增资源组，如下图所示。关于自定义资源组的详细信息请参考[新增调度资源](../../../../../intl.zh-CN/使用指南/数据集成/常见配置/新增任务资源.md#)。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756611602_zh-CN.png)
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756611603_zh-CN.png)
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756611604_zh-CN.png)

        完成上述步骤后，按照提示安装自定义资源组agent，观察到当前状态为可用，说明新增自定义资源组成功：

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756611605_zh-CN.png)
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756611606_zh-CN.png)
...
2.  新建数据源
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756611607_zh-CN.png)
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756611608_zh-CN.png)
...
3.  配置数据同步任务
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756611609_zh-CN.png)

    完成导入模板后，同步任务会转入脚本模式，本文中配置脚本如下，相关解释请参见：[脚本模式配置](../../../../../intl.zh-CN/使用指南/数据集成/作业配置/配置Reader插件/脚本模式配置.md#)。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756611610_zh-CN.png)
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756611611_zh-CN.png)

    完成配置后，点击运行。如果提示任务运行成功，则说明同步任务已完成。如果运行失败，可通过复制日志进行进一步排查。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756611612_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21113/155056756611614_zh-CN.png)
