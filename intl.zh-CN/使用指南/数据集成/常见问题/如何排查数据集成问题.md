...
当出现数据集成问题时，您可以参考[添加数据源典型问题场景](intl.zh-CN/使用指南/数据集成/常见问题/添加数据源典型问题场景.md#)进行排查。需要查看的数据源的相关信息如下：
...
3.  确认数据源测试连通性是否成功。
    ...
    参见[配置数据源](intl.zh-CN/使用指南/数据集成/数据源配置/支持的数据源.md#)文档，检查其数据源相关信息是否填错。通常填错的情况如下：
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16281/15501129488678_zh-CN.png)

## 界面模式报错，复制排查码 {#section_n3w_ynb_r2b .section}

如果报错，请复制排查码，并提供给处理人员。

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16281/15501129488679_zh-CN.jpg)
...
-   **数据源信息填写错误**
    ...
    -   DRDS连接数据超时
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16281/15501129488686_zh-CN.png)
    ...
    -   系统内部问题
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16281/15501129488687_zh-CN.png)
...
-   **脏数据**
    ...
    -   **JDBC的格式填错**
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16281/15501129488688_zh-CN.png)
    ...
    -   **测试连通性失败**
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16281/15501129498692_zh-CN.png)
