...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/15542854497925_zh-CN.png)
...
-   规范化数据开发流程示例
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428544913593_zh-CN.jpg)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/15542854507926_zh-CN.png)
...
-   通过输入父节点输出名搜索
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545113932_zh-CN.png)

-   通过输入父节点输出名的表名称进行搜索

    通过该方法搜索必须保证父节点的某一个输出名，为本节点SQL语句中INSERT或CREATE之后的表名称，形如projectname.表名（此类输出名一般可通过自动解析获得）。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545113933_zh-CN.png)

    执行**提交**后，该输出名即可通过搜索表名的方式被其他节点搜索到。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545213934_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545213595_zh-CN.jpg)

如果您构建了存在依赖关系的多个任务且满足条件：下游任务的输入表均来自上游任务的输出表，则通过自动解析功能即可实现全工作流依赖关系的快速配置。

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545213935_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545213937_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545221179_zh-CN.png)
...
-   **手动添加依赖的上游节点示例**
    1.  新建三个节点，系统会默认为它们分别配置一个输出名称。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545213938_zh-CN.png)

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545213939_zh-CN.png)

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545213940_zh-CN.png)

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545213941_zh-CN.png)

    2.  将最上游节点task\_1配置依赖本项目root根节点，单击**保存**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545213942_zh-CN.png)

    3.  配置task\_2依赖task\_1的输出名称，单击**保存**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545313943_zh-CN.png)

    4.  配置task\_3依赖task\_2的输出名称，单击**保存**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545313944_zh-CN.png)

    5.  配置完成后，单击**提交**，判断依赖关系是否正确。如果提交成功则说明依赖配置无误。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545313945_zh-CN.png)
...
-   **通过拖拽形成依赖关系示例**
    ...
    2.  通过拖拽方式将三个task连接起来。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545313947_zh-CN.png)

    3.  查看task\_2、task\_3的依赖配置，可看到已自动生成依赖的父节点输出名。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545313948_zh-CN.png)

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545313949_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155428545313952_zh-CN.png)
