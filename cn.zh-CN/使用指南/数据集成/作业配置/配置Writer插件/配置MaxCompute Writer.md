...
根据您配置的源头项目/表/分区/表字段等信息，在底层实现上可通过Tunnel将数据写入MaxCompute中。常用的Tunnel命令请参见[Tunnel命令操作](../../../../../intl.zh-CN/用户指南/数据上传下载/Tunnel命令操作.md#)。
...
1.  选择数据源
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16247/15541880178125_zh-CN.png)
...
3.  通道控制
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16221/15541880177675_zh-CN.png)
