...
**说明：** 在开始配置HybridDB for PostgreSQL Writer插件前，请首先配置好数据源，详情请参见[配置HybridDB for PostgreSQL数据源](cn.zh-CN/使用指南/数据集成/数据源配置/配置HybridDB for PostgreSQL数据源.md#)。
...
|数据集成内部类型|HybridDB for PostgreSQL数据类型|
|:-------|:--------------------------|
...
1.  **选择数据源**
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/62207/154229531532025_zh-CN.png)
...
2.  **字段映射**，即上述参数说明中的column。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/62207/154229531532030_zh-CN.png)
...
3.  **通道控制**
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/62209/154229531532018_zh-CN.png)
