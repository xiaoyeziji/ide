...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627028713932_zh-CN.png)

DataWorks V2.0提供[自动推荐](#)、[自动解析](#)和[自定义配置](#)三种依赖配置模式。依赖关系实际操作示例请参考[设置调度依赖最佳实践](../../../../cn.zh-CN/最佳实践/数据开发/设置调度依赖最佳实践.md#)。

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/15562702877925_zh-CN.png)
...
-   在进行调度依赖关系配置前，您需要了解以下基本概念：
    ...
    -   SQL语句：此处指[MaxCompute SQL](../../../../cn.zh-CN/用户指南/SQL/SQL概述.md#)。
...
-   规范化数据开发流程示例
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627028813593_zh-CN.jpg)
...
依赖的上游节点指当前节点依赖的父节点，此处需填写上游节点的输出名称（一个节点可同时存在多个输出名称，视情况填写您需要的输出即可），而非上游节点名。您可手动搜索上游输出名进行添加，也可通过SQL[血缘关系](cn.zh-CN/使用指南/数据开发/界面功能/血缘关系.md#)代码解析得到。

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/15562702887926_zh-CN.png)
...
-   通过输入父节点输出名的表名称进行搜索
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627028813933_zh-CN.png)

    执行**提交**后，该输出名即可通过搜索表名的方式被其他节点搜索到。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627028813934_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627028845513_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627028813595_zh-CN.jpg)

如果您构建了存在依赖关系的多个任务且满足条件：下游任务的输入表均来自上游任务的输出表，则通过自动解析功能即可实现全工作流依赖关系的快速配置。

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627028813935_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627028913937_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029121179_zh-CN.png)
...
-   **手动添加依赖的上游节点示例** 
    1.  新建三个节点，系统会默认为它们分别配置一个输出名称。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029113938_zh-CN.png)

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029113939_zh-CN.png)

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029213940_zh-CN.png)

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029213941_zh-CN.png)

    2.  将最上游节点task\_1配置依赖本项目root根节点，单击**保存**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029213942_zh-CN.png)

    3.  配置task\_2依赖task\_1的输出名称，单击**保存**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029213943_zh-CN.png)

    4.  配置task\_3依赖task\_2的输出名称，单击**保存**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029213944_zh-CN.png)

    5.  配置完成后，单击**提交**，判断依赖关系是否正确。如果提交成功则说明依赖配置无误。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029213945_zh-CN.png)
...
-   **通过拖拽形成依赖关系示例** 
    ...
    2.  通过拖拽方式将三个task连接起来。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029213947_zh-CN.png)

    3.  查看task\_2、task\_3的依赖配置，可看到已自动生成依赖的父节点输出名。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029213948_zh-CN.png)

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029213949_zh-CN.png)
...
-   Q：自动解析后提交失败，报错**依赖的父节点输出projectname.table不存在，不能提交本节点，请先提交父节点。**
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029213952_zh-CN.png)
...
-   Q：依赖的上游没有解析到父节点ID，提交报错。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029345514_zh-CN.png)
    ...
    1.  找到产出该表的节点任务，查看该节点任务的本节点输出。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029345515_zh-CN.png)

    2.  如果是本地上传的表数据，或者不需要依赖该节点，您可以选择在代码区右键，选择**删除输入**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/155627029345516_zh-CN.png)
