...
Stream Studio是DataWorks旗下的一站式实时计算开发平台。Stream Studio当前在华东2（上海）区域进行限量内测，如需开通试用，请在钉钉DataWorks数加交流群（群号：11718465）中查看群公告。
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/129837/155412311739369_zh-CN.png)
