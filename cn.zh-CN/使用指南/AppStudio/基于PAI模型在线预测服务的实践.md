...
## 本次实践的流程 {#section_uzb_mpc_z2b .section}

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/18990/153680814110837_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/18990/153680814210844_zh-CN.png)
...
做好准备工作后，我们就可以开始准备下一步「预测服务的App」开发了。

## 定义接口 {#section_edv_dsc_z2b .section}

根据PAI模型的预测服务接口格式，我们先定义一个接口来match它的格式，测试一下连通性。

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/18990/153680814210845_zh-CN.png)
...
由于每次读取O特S征文件的内容是固定的，我们可以将它优化到构造函数里，起服务时就load好数据。
...
输入参数可以是批量地获取预测结果，只要组织成 `[{},{},...,{}]` 的结构即可，直接调用 `syncPredict`接口。
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/18990/153680814210847_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/18990/153680814210848_zh-CN.png)
