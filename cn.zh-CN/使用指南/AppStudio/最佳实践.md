...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345699607_zh-CN.png)
...
2.  填写对话框中的配置项。输入工程名为YunQISample，**base package**配置项中输入 com.alibaba.dataworks。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345699608_zh-CN.png)

3.  单击**确定**，即可创建项目。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345699609_zh-CN.png)
...
1.  新建接口定义，并生成模板代码。
    ...
    2.  填写添加接口对话框中的各配置项。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345699610_zh-CN.png)
    ...
    4.  选择接口列表中Pet行对应的**生成代码**。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345699611_zh-CN.png)

    5.  查看代码无误后，单击**确认**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345699612_zh-CN.png)
...
2.  在模板代码中开发一个展示OSS数据源的服务。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345699613_zh-CN.png)
...
3.  测试后端服务。
    ...
    1.  单击**运行**。
        ...
        **说明：** 第一次运行需要输入CONFIG信息，Name为main.Main，class选择com.alibaba.dataworks.Main。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345699615_zh-CN.png)

    2.  单击**OK**，等待运行完成，弹出信息框。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709616_zh-CN.png)

    3.  单击右侧的后端链接，在新窗口打开页面。地址后面加上/pets，按回车键，测试有数据即可。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709617_zh-CN.png)
...
1.  打开santa/pages/home.santa文件。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709618_zh-CN.png)

2.  选择**代码模式**，清空Relim中的代码。
3.  单击**保存**，切换至**可视化模式**。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709619_zh-CN.png)

4.  从左侧的控件列表拖一个表格控件到工作区。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709620_zh-CN.png)

5.  单击选择工作区的空间，在右侧的组件配置区域配置组件。

    接口地址输入./pets，即前文开发的后端接口。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709621_zh-CN.png)
...
7.  单击**OK**并**保存**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709622_zh-CN.png)
...
8.  配置PET数据源中的5个属性。
    -   第一个表格列配置项：标题输入Name、字段输入name，单击右上角的**保存**。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709623_zh-CN.png)

    -   第二个表格配置项：标题输入Species，字段输入species，单击右上角的**保存**。

        配置完成后，单击**+**，准备输入第三个表格配置项。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709624_zh-CN.png)
    ...
    -   第三个表格配置项：标题输入FavFoods，字段输入favFoods，单击**代码定制**，输入如下内容，单击**OK**并**保存**。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709625_zh-CN.png)

    -   第四个表格配置项：标题输入BirthYear，字段输入birthYear，单击**保存**。

        配置完成后，单击**+**，准备输入第五个表格配置项。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709626_zh-CN.png)
    ...
    -   第五个表格配置项：标题输入Photo，字段输入photo，单击**代码定制**，输入如下内容，单击**OK**并**保存**。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709627_zh-CN.png)
...
10. 确认左侧代码和下述内容一致，单击**reload**并**保存**。
    ...
    **说明：** 如果代码不一致，可以进行复制。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709628_zh-CN.png)
...
2.  单击**运行**，等待项目启动完成。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709629_zh-CN.png)

3.  单击右上角生成的前端项目链接，即可打开新窗口，看到最终效果。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709605_zh-CN.png)
...
1.  拖放一个表单放在表格上方。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345709630_zh-CN.png)
...
2.  设定表单和表格的关联关系。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17735/15349345719631_zh-CN.png)
