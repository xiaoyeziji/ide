...
This manual is for the Alibaba cloud MVP Meetup workshop. The paper mainly discusses how to monitor the data quality in the process of using the data workshop, set up quality monitoring rules, monitor alerts and tables.

## Prerequisites {#section_q5v_qss_s2b .section}

Please complete the experiment[Data acquisition: Log data upload](intl.en-US/Best Practices/Workshop/Data acquisition: Log data upload.md#) and [Data processing: user portraits](intl.en-US/Best Practices/Workshop/Data processing: user portraits.md#)before proceeding with this experiment.
...
-   ods\_raw\_log\_d
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069061_en-US.png)

    Select the ods\_raw\_log\_d table and click **Rule Configuration** to go to the following page.

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069062_en-US.png)
    ...
    For this type of daily log data, you can configure the partition expression for the table. There are several kinds of partition expressions, and you can select dt = $ \[yyyymmdd-1\]. Refer to the documentation[Parameter configuration](../../../../intl.en-US/User Guide/Data development/Scheduling Configuration/Parameter configuration.md#) for detailed interpretation of scheduling expressions.

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069065_en-US.png)
    ...
    **Note:** 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069068_en-US.png)

    When you select to create a rule, the following interface appears.

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069070_en-US.png)

    Click **Add monitoring rule** and a prompt window appears for you to configure the rule.

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069072_en-US.png)
    ...
    **Note:** 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069075_en-US.png)
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069077_en-US.png)

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069078_en-US.png)
    ...
    **Note:** 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069087_en-US.png)
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069104_en-US.png)

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069105_en-US.png)

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069106_en-US.png)

    After the subscription management settings are set up, you can view and modify them in **My Subscription**.

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069107_en-US.png)
...
-   ods\_user\_info\_d
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606069115_en-US.png)
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606079121_en-US.png)
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606079123_en-US.png)
    ...
    **ods\_log\_info\_d**
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606079126_en-US.png)
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606079127_en-US.png)
...
-   rpt\_user\_info\_d
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606079130_en-US.png)
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606079133_en-US.png)

    Continue to add monitoring and table rules.

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16423/15370606079135_en-US.png)
