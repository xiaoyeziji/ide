...
-   After adding MySQL and Oracle, SQL Server data sources ,**Batch testing connectivity** are required. Only when **Connected State** is**Success**, the specific bulk data source would be an available data source option for **Fast Batch Cloud Migration**.
...
6.  InData SourcePage, select specific data source, click**Bulk testing connectivity**.

    **Note:** Only if the Connected Status of the data source is **Success**, you can operate the bulk cloud migration.

7.  Select the data sources that you want to upload then click**Bulk Cloud Migration**.
