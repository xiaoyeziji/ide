...
In this article we will show you the data types and parameters supported by Stream Reader and how to configure Reader in both wizard mode and script mode.
